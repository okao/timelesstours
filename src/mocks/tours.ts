...
export const exclusivePackage = {
  ...
  itinerary: [
    ...
    { day: 2, title: "Coral Garden , Shark Point & Sandbank Adventure", description: "Start your adventure with a visit to a pristine coral reef teeming with colorful marine life. Then head to a sandbank where you can observe friendly reef sharks in their natural habitat. Snorkel through vibrant coral gardens and enjoy a picnic lunch on the sandbank." },
    { day: 3, title: "Manta Cruise , Dolphine & Turtle Point", description: "Embark on a magical manta ray cruise where you'll have the opportunity to swim with these gentle giants. After the manta encounter, visit a famous turtle point where you can snorkel alongside graceful sea turtles in crystal-clear waters." },
