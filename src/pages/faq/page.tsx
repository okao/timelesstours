...
export default function FAQ() {
	...
	return (
		<>
			<SEO
				title="Frequently Asked Questions | Timeless Tours Maldives"
				description="Find answers to common questions about our Maldives tour packages, booking process, what's included, and more. Get all the information you need for your Maldivian adventure."
				keywords="Maldives tour FAQ, tour questions, booking FAQ, Maldivian tour information, tour package questions"
				url="https://thetimelesstours.com/faq"
							...
							<div className="bg-white rounded-lg shadow-lg p-8 text-center">
								...
								<a
									href={`https://wa.me/9609404623?text=${encodeURIComponent(
										'Hello! I have a question about your tours.'
									)}`}
									target="_blank"
					...
					<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
							{faqTopics.map((topic) => (
								<div
									key={topic.id}
									className="bg-stone-50 rounded-lg p-6 hover:bg-stone-100 transition-colors duration-300 cursor-pointer"
								>
									<i
										className={`${topic.icon} text-2xl text-teal-600 mb-3`}
									></i>
