...
export default function About() {
	...
	const aboutStoryPara1 =
		'Founded in the heart of Malé, Timeless Tours Maldives was born from a passion for sharing the untouched beauty and rich culture of our island nation. We believe that travel should be more than just visiting places – it should be about creating connections, understanding cultures, and making memories that last a lifetime.';
	const aboutStoryPara2 =
		'Our team of local experts brings decades of combined experience in hospitality and marine adventures, ensuring every guest experiences the authentic spirit of the Maldives while enjoying the highest standards of safety and comfort.';
	const aboutTeamTitle = 'Meet Our Team';
	const aboutTeamSubtitle =
	...
	const aboutPromiseSustainableDesc =
		"We're committed to responsible tourism that benefits local communities and preserves our pristine marine environment.";
	const aboutPromiseComfortTitle = 'Comfort & Luxury';
	const aboutPromiseComfortDesc =
		'Every detail is carefully planned to ensure your comfort while maintaining the authentic spirit of the Maldives.';
	const aboutPromiseExperiencesTitle = 'Unforgettable Experiences';
	const aboutPromiseExperiencesDesc =
		'We create moments that will stay with you long after you leave our beautiful islands.';
	...
	return (
		<>
			<SEO
				title="About Us | Timeless Tours Maldives"
				description="Learn about Timeless Tours Maldives - your gateway to authentic Maldivian experiences. Founded in the heart of Malé, we share the untouched beauty and rich culture of the Maldives."
				keywords="about Timeless Tours, Maldivian tour company, local tour guides, authentic Maldives experiences, Fulidhoo tours"
				url="https://thetimelesstours.com/about"
			/>
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
							{values.map((value, index) => (
								...
								>
									...
									>
										<i
											className={`${value.icon} text-2xl text-teal-600 group-hover:text-white transition-colors duration-500`}
										></i>
									</div>
									<h3 className="text-lg font-semibold text-slate-800 mb-2 group-hover:text-teal-600 transition-colors duration-500">
										{value.title}
									</h3>
					...
					<div className="animate-subtle-zoom max-w-4xl mx-auto px-4 text-center">
						...
						<div className="grid md:grid-cols-3 gap-8">
							<div className="group p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 hover:border-teal-300 hover:shadow-xl hover:shadow-teal-100/50 transition-all duration-500 hover:-translate-y-2 cursor-pointer">
								<h3 className="text-xl font-semibold mb-4 group-hover:text-teal-300 transition-colors duration-500">
									{aboutPromiseSustainableTitle}
								</h3>
