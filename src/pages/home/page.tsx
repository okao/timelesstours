...
export default function Home() {
	...
	const homeStructuredData = {
		...
		description:
			'Authentic Maldivian tour experiences in Fulidhoo, Vaavu Atoll',
		potentialAction: {
			'@type': 'SearchAction',
			target:
				'https://thetimelesstours.com/tours?search={search_term_string}',
	...
	return (
		<>
			<SEO
				...
				url="https://thetimelesstours.com"
				image="https://images.unsplash.com/photo-1505142468610-359e7d316be0?w=1200&h=630&fit=crop&q=80"
			...
			<div className="min-h-screen bg-stone-50">
				...
				<section ref={aboutRef} className="py-20 scroll-reveal">
					<div className="max-w-6xl mx-auto px-4 text-center">
						...
						<div className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed space-y-4">
							<p>
								At timeless tours we invite you to lose yourself in
								moments that lasts forever.
							</p>
							<p>
								Drift into the heart of the Maldives — a shimmering
								chain of white pearls resting gently upon the
								turquoise embrace of the Indian Ocean.
							</p>
							<p>
								Every tour with us is a whisper of wonder, a story
								written by the sea, and a memory that truly becomes
								timeless.
							</p>
						</div>
					</div>
					...
					<div className="max-w-7xl mx-auto px-4">
						<div className="text-center mb-12">
							...
							<p className="text-lg text-slate-600 max-w-2xl mx-auto">
								The ultimate Maldivian experience — 7 days of
								adventure, relaxation, and unforgettable marine
				...
				<section
					ref={toursRef}
					className="py-20 bg-white scroll-reveal"
				>
					<div className="max-w-7xl mx-auto px-4">
