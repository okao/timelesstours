...
export default function Tours() {
	...
	// Structured data for tours page
	const toursStructuredData = {
		'@context': 'https://schema.org',
		'@type': 'ItemList',
		name: 'Maldives Tour Packages',
		description:
			'Explore our collection of authentic Maldivian tour experiences in Fulidhoo, Vaavu Atoll',
	...
	const destinations = [
		...new Set(toursData.map((tour) => tour.destination)),
	];
	const durations = [
		...new Set(toursData.map((tour) => tour.duration)),
	];
	...
	const filteredTours = toursData.filter((tour) => {
		const destinationMatch =
			...
			selectedDestination
				.toLowerCase()
				.includes(tour.destination.toLowerCase());

		const durationMatch =
			selectedDuration === 'all' ||
			tour.duration
				.toLowerCase()
				.includes(selectedDuration.toLowerCase()) ||
			selectedDuration
				.toLowerCase()
				.includes(tour.duration.toLowerCase());
	...
	return (
		<>
			<SEO
				title="Maldives Tour Packages | Timeless Tours"
				description="Discover our collection of authentic Maldivian tour experiences. From snorkeling with manta rays to island hopping adventures in Fulidhoo, Vaavu Atoll."
				keywords="Maldives packages, Fulidhoo tours, Vaavu Atoll packages, snorkeling tours, manta ray tours, whale shark tours, island hopping Maldives"
				url="https://thetimelesstours.com/tours"
			...
			<div className="min-h-screen bg-stone-50">
				...
				>
					<div className="animate-ocean-wave max-w-4xl mx-auto px-4">
						...
						<p className="hero-subtitle text-xl text-gray-200">
							Discover the beauty of tropical paradise through our
							curated packages
						</p>
					</div>
				</section>
				...
				<section
					ref={filtersRef}
					className="py-12 bg-white scroll-reveal"
				>
						...
						{filteredTours.length === 0 ? (
							<div className="text-center py-12">
								...
								<p className="text-slate-500 text-sm mt-2">
									Total tours available: {toursData.length}
								</p>
							</div>
						) : (
							<div>
